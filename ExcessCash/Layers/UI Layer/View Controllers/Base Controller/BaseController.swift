...
class BaseController: UIViewController {
    ...
    @IBAction func actionForOperatorAddButton(_ sender: UIButton) {
        let calculatorButton = sender as! CalculatorButton
        handleOperator(calculatorButton.getButtonValue())
    }
    
    @IBAction func actionForNumberExponentialTenButton(_ sender: Any) {
        handleOperator(OperatorType.Add.rawValue)
        let calculatorButton = sender as! CalculatorButton
        handleNumber(String(calculatorButton.getButtonValue().dropFirst()))
        handleCalculation()
    }
    
    @IBAction func actionForNumberMultiplicationTenButton(_ sender: Any) {
        handleOperator(OperatorType.Multiply.rawValue)
        let calculatorButton = sender as! CalculatorButton
        handleNumber(String(calculatorButton.getButtonValue().dropFirst()))
        handleCalculation()
    }
    ...
    @IBAction func actionForRegetPrice(_ sender: Any) {
        if let callBackGetPrice = callbackRegetPrice {
            deepClear()
            callBackGetPrice()
        }
    }
